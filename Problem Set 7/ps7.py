...
class WordTrigger(Trigger):
    ...
    def isWordIn(self, text):
        ...
        for i in range(len(l)):
            if l[i] in punctuations:
                l[i] = ""
        modifiedText = "".join(l)
        modifiedList = modifiedText.split(' ')
        for word in modifiedList:
...
class PhraseTrigger(Trigger):
    ...
    def evaluate(self, story):
        self.story = story
        if self.phrase in self.story.getTitle() or self.phrase in self.story.getSubject() or self.phrase in self.story.getSummary():
            return True
        else:
            return False
...
def makeTrigger(triggerMap, triggerType, params, name):
    ...
    if triggerType == 'TITLE':
        ...
        raise ValueError('No such Trigger type')
